<div class="sidebar-list-single">
   <div class="top-company-list">
      <div class="company-list-logo">
         ...
         <img src="{{$related->company->user->pathAttachment()}}" alt="company list 1">
         </a>
      </div>
      <div class="company-list-details">
         ...
         <p class="varify"><i class="fa fa-check"></i>Rango de salario : S/{{$related->min_salary}} - S/{{$related->max_salary}}</p>
